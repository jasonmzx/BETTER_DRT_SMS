...
let static_table_generate = async () => {
    const db_promise = db.promise();
    db_promise.query(`CREATE TABLE static_times(routeId VARCHAR(4), serviceId VARCHAR(20), tripId VARCHAR(70), stopId MEDIUMINT UNSIGNED, arrivalTime INT UNSIGNED, orientation VARCHAR(70), tripHeadsign VARCHAR(80));`);
